...
export const Abilities: {[abilityid: string]: AbilityData} = {
	...
	megaforce: {
		...
		desc: "This Zelckeymon's attacks have their power multiplied by 1.25.",
		shortDesc: "This Zelckeymon has 1.25x move power.",
	},
	//#05 - Hulking
	hulking: {
		num: 5,
	...
	megaarmor: {
		num: 17,
		desc: "This Zelckeymon takes 0.75x damage from attacks.",
		shortDesc: "This Zelckeymon's takes 0.75x damage from attacks.",
		name: "Mega-Armor",
		rating: 5,
		onSourceModifyDamage(damage, source, target, move) {

...
/* 	wait: {
	...
	burn: {
		...
		basePower: 0,
		category: "Status",
		desc: "Causes the target to become burned.",
	...
	humidify: {
		...
		basePower: 0,
		category: "Status",
		desc: "Causes Normal-type moves to become Water type this turn. The effect happens after other effects that change a move's type. Also changes the weather to Rain Dance.",
		shortDesc: "Weather becomes Rain Dance. Normal moves become Water type this turn.",
		name: "Humidify",
		pp: 20,
		priority: 1,
		flags: {},
	...
	sneakbeak: {
		...
		basePower: 90,
		category: "Physical",
		desc: "This move combines Flying in its type effectiveness against the target. Fails if the target did not select a physical attack, special attack, or Me First for use this turn, or if the target moves before the user.",
	...
	trap: {
		...
		basePower: 0,
		category: "Status",
		desc: "Traps the target for 4-5 turns. Does not check accuracy. Not affected by protection.",
		shortDesc: "Traps the target for 4-5 turns. Almost never misses. Ignores protection.",
		pp: 30,
		priority: 0,
		flags: {mirror: 1},
